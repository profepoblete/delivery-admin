            ...
            <div class="pb-2 px-5">
                ...
                <div class="mx-5 mb-4 pb-3 border-bottom">
                    <h3 class="mb-0 nav-item d-inline-block pl-2 py-0 font-weight-normal" style="border-style: solid; border-width: 0 0 0 7px; border-color: #FFB800;">
                        <span class="small text-muted font-italic">Agregar</span><br><i class="bi bi-person"></i> Usuarios
                    </h3>
                </div>
                ...
                <div class="px-4 mx-2">
                    ...
                    <div class="col-sm-12 px-3">
                        <form id="formAdd" name="form" autocomplete="off" action="${pageContext.request.contextPath}/AgregarUsuario" method="post">
                            ...
                            <div class="row">    
                                <div class="col">
                                    ...
                                    <div class="col-sm-12 px-0">
                                        <input type="text" id="rut" class="form-control" name="rut" value="" required>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="col-sm-12 px-0">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="col-sm-12 px-0">
                                        <label for="contrasena" class="col-form-label">Contraseña <b class="text-secondary">*</b></label> 
                                    </div>
                                    <div class="col-sm-12 px-0">
                                        <input type="password" id="password" class="form-control" name="contrasena" autocomplete="new-password" required>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="col-sm-12 px-0">
                                        <label for="contrasena2" class="col-form-label">Repetir Contraseña <b class="text-secondary">*</b></label> 
                                    </div>
                                    <div class="col-sm-12 px-0">
                                    ...
                                    <div class="col-sm-12 px-0">
                                        <select class="form-control" name="puntoVenta">
                                            ...
                                            <c:forEach var="puntoVenta" items="${puntosVenta}">
                                                <option value="${puntoVenta.idPuntoVenta}">
