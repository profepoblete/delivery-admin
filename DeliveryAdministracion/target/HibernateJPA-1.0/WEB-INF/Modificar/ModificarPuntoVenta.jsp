...
<html>
    <head>
        ...
        <title>Modificar Punto Venta</title>
            ...
            <div class="pb-2 px-5">
                ...
                <div class="mx-5 mb-4 pb-3 border-bottom">
                    <h3 class="mb-0 nav-item d-inline-block pl-2 py-0 font-weight-normal" style="border-style: solid; border-width: 0 0 0 7px; border-color: #FFB800;">
                        <span class="small text-muted font-italic">Modificar</span><br><i class="bi bi-credit-card"></i> Puntos de venta
                    </h3>
                </div>
                ...
                <div class="px-4 mx-2">
                    ...
                    <div class="col-sm-12 px-3">
                        <form id="formAdd" name="form" action="${pageContext.request.contextPath}/ModificarPuntoVenta" enctype="multipart/form-data" method="post">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="col-sm-12 px-0">
                                        <input type="text" class="form-control" name="nombre" value="${puntoVenta.nombre}" required>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="col-sm-12 px-0">
                                    ...
                                    <div class="col-sm-12 px-0">
                                        <input type="text" class="form-control" name="empresa" value="${puntoVenta.empresa}" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="col-sm-12 px-0">
                                        <label for="imagen" class="col-form-label pb-1">Imagen</label> 
                                    </div>
                                    <div class="col-sm-12 px-0">
                                        <!--<input type="file" class=" form-control-file pl-0" name="imagen" accept="image/png, image/jpeg" required>-->
                                        <input type="file" class="custom-file-input form-control" id="inputImagen" name="imagen" accept="image/png, image/jpeg">
                                    ...
                                    <div class="col-sm-12 px-0">
                                        <select class="form-control" name="sede" required>
                                            <c:forEach var="sede" items="${sedes}">
                                                <option value="${sede.idSede}" <c:if test="${sede.idSede==puntoVenta.sede.idSede}">selected</c:if>>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="col-sm-12 px-0">
                                        <input type="time" class="form-control"  name="horaInicio" value="${puntoVenta.horaInicio}" required>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="col-sm-12 px-0">
                                    ...
                                    <div class="col-sm-12 px-0">
                                        <input type="time" class="form-control" id="horaFin" name="horaFin" value="${puntoVenta.horaFin}" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="col-sm-12 px-0">
                                        ...
                                        <input type="checkbox" class="align-middle d-inline-block ml-4" name="activo" <c:if test="${puntoVenta.activo==true}">checked=""</c:if>>
                                    </div>
                                </div>
                            </div>
