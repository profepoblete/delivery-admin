            ...
            <div class="pb-2 px-5">
                ...
                <div class="mx-5 mb-4 pb-3 border-bottom d-flex justify-content-between align-items-end">
                    <h3 class="mb-0 nav-item d-inline-block pl-2 py-0 font-weight-normal" style="border-style: solid; border-width: 0 0 0 7px; border-color: #FFB800;">
                        <span class="small text-muted font-italic">Agregar</span><br><i class="bi bi-geo-alt"></i> Ubicaciones
                    </h3>
                ...
                <div class="px-4 mx-2">
                    ...
                    <div class="col-sm-12 px-3">
                        <form id="formAdd" name="form" action="${pageContext.request.contextPath}/AgregarUbicacion" method="post">
                            <input type="hidden" name="idSede" value="${sede.idSede}">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="col-sm-12 px-0">
                                        <input type="text" class="form-control" name="nombreEdificio" id="nombreEdificio" autocomplete="off" required>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="col-sm-12 px-0">
                                    ...
                                    <div class="col-sm-12 px-0">
                                        <input type="text" class="form-control" name="piso" id="piso" autocomplete="off" required>
                                    </div>
                                </div>
                            </div>
